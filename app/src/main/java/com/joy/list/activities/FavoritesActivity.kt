 ...
 */
class FavoritesActivity : AppCompatActivity(), ItemAdapter.OnItemListener {
    private lateinit var itemAdapter: ItemAdapter
    private lateinit var itemViewModel: ItemViewModel

    private val list = List(FAVORITES_TITLE, FAVORITES_COLOR)
     ...
     */
    companion object {
        private const val FAVORITES_COLOR = "#0099cc"
        private const val FAVORITES_TITLE = "Favorites"
    }
    ...
    override fun onItemFavorite(item: Item, position: Int) {
        ...
        val snackbar = Snackbar.make(findViewById(R.id.coordinator), R.string.msg_item_removed_from_favorites, Snackbar.LENGTH_SHORT)
    ...
    private fun populateItems() {
        ...
        val recyclerItems: RecyclerView = findViewById(R.id.recycler_favorite_items)
        ...
        itemViewModel.getAllItemsFrom(Item.INCOMPLETE, Item.FAVORITE).observe(this, Observer { items ->
        ...
        ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT) {
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                if (item.getReminderId() != null)
                    ActivityHelper.dismissReminder(this@FavoritesActivity, item)
                ...
                val snackbar = Snackbar.make(findViewById(R.id.coordinator), R.string.msg_item_deleted, Snackbar.LENGTH_SHORT)
                    ...
                    .setAction(R.string.action_undo) {
                        ...
                        if (item.getReminderId() != null)
                            ActivityHelper.setReminder(this@FavoritesActivity, list, item)
                    }
